...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "privacy.permissions": "Autorisations (application mobile)",
    "privacy.permissionsDesc": "L'application mobile peut demander des autorisations pour les notifications (contrôles de lecture), la localisation (détection Chromecast) et le stockage (sauvegarde d'enregistrements). Ces autorisations sont optionnelles et les données restent sur votre appareil.",
  ...
  en: {
    ...
    "privacy.permissions": "Permissions (mobile app)",
    "privacy.permissionsDesc": "The mobile app may request permissions for notifications (playback controls), location (Chromecast detection), and storage (recording saves). These permissions are optional and data stays on your device.",
  ...
  es: {
    ...
    "privacy.permissions": "Permisos (aplicación móvil)",
    "privacy.permissionsDesc": "La aplicación móvil puede solicitar permisos para notificaciones, ubicación y almacenamiento. Estos son opcionales y los datos permanecen en su dispositivo.",
  ...
  de: {
    ...
    "privacy.permissions": "Berechtigungen (Mobile App)",
    "privacy.permissionsDesc": "Die mobile App kann Berechtigungen für Benachrichtigungen, Standort und Speicher anfordern. Diese sind optional.",
  ...
  ja: {
    ...
    "privacy.permissions": "権限（モバイルアプリ）",
    "privacy.permissionsDesc": "モバイルアプリは通知、位置情報、ストレージの権限を要求する場合があります。これらは任意です。",
