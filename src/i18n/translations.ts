...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "tbmModal.intro": "La TimeBack Machine est une fonctionnalité exclusive de Radio Sphere qui révolutionne l'écoute de la radio en ligne. Fini de rater un moment important en direct !",
    "tbmModal.bufferTitle": "🔄 Le buffer intelligent (5 minutes)",
    "tbmModal.bufferDesc": "Dès que vous écoutez une station, Radio Sphere enregistre automatiquement les 5 dernières minutes en arrière-plan dans un buffer circulaire. Vous n'avez rien à activer : c'est automatique et transparent.",
    ...
    "privacy.dataCollectionDesc": "Radio Sphere ne collecte aucune donnée personnelle identifiable. Aucune inscription n'est requise pour utiliser le service. Nous ne suivons pas vos habitudes d'écoute et ne partageons aucune information avec des tiers.",
    ...
    "privacy.thirdPartyDesc": "Les flux audio sont fournis directement par les stations de radio via l'API communautaire Radio Browser (radio-browser.info). Radio Sphere ne contrôle pas le contenu diffusé par ces stations. Les flux audio peuvent contenir des publicités insérées directement par les stations émettrices — Radio Sphere n'a aucun moyen de les filtrer ou de les bloquer.",
    ...
    "settings.analyticsDesc": "Radio Sphere utilise Umami Analytics, une solution de mesure d'audience respectueuse de la vie privée et conforme au RGPD.",
    ...
    "onboarding.title": "Bienvenue sur Radio Sphere",
    "onboarding.free": "100% Gratuit",
    "onboarding.freeDesc": "Accès illimité sans abonnement",
    "onboarding.noAds": "Zéro Pub Ajoutée",
    "onboarding.noAdsDesc": "Aucune pub ajoutée par Radio Sphere. Les stations peuvent inclure leurs propres annonces dans leur flux.",
    ...
    "home.androidTitle": "Radio Sphere sur Android",
  ...
  en: {
    ...
    "tbmModal.intro": "The TimeBack Machine is a Radio Sphere exclusive that revolutionizes online radio listening. Never miss an important live moment again!",
    "tbmModal.bufferTitle": "🔄 Smart buffer (5 minutes)",
    "tbmModal.bufferDesc": "As soon as you listen to a station, Radio Sphere automatically records the last 5 minutes in a circular buffer. You don't need to activate anything: it's automatic and seamless.",
    ...
    "privacy.dataCollectionDesc": "Radio Sphere does not collect any personally identifiable data. No registration is required to use the service. We do not track your listening habits and do not share any information with third parties.",
    ...
    "settings.analyticsDesc": "Radio Sphere uses Umami Analytics, a privacy-friendly and GDPR-compliant analytics solution.",
    ...
    "onboarding.title": "Welcome to Radio Sphere",
    "onboarding.free": "100% Free",
    "onboarding.freeDesc": "Unlimited access, no subscription",
    "onboarding.noAds": "Zero Added Ads",
    "onboarding.noAdsDesc": "No ads added by Radio Sphere. Stations may include their own ads in their streams.",
    "onboarding.tbm": "TimeBack Machine",
    ...
    "home.androidTitle": "Radio Sphere on Android",
    "home.androidDesc": "Listen to your favorite stations anywhere, with Android Auto, Chromecast and offline mode.",
  ...
  es: {
    ...
    "tbmModal.intro": "La TimeBack Machine es una exclusiva de Radio Sphere que revoluciona la escucha de radio online. ¡No te pierdas ningún momento importante en directo!",
    "tbmModal.bufferTitle": "🔄 Búfer inteligente (5 minutos)",
    "tbmModal.bufferDesc": "En cuanto escuchas una emisora, Radio Sphere graba automáticamente los últimos 5 minutos en un búfer circular. No necesitas activar nada: es automático y transparente.",
    ...
    "privacy.dataCollectionDesc": "Radio Sphere no recopila ningún dato personal identificable. No se requiere registro para usar el servicio.",
    ...
    "settings.analyticsDesc": "Radio Sphere utiliza Umami Analytics, una solución de medición de audiencia respetuosa con la privacidad y conforme al RGPD.",
    ...
    "onboarding.title": "Bienvenido a Radio Sphere",
    "onboarding.free": "100% Gratis",
    "onboarding.freeDesc": "Acceso ilimitado sin suscripción",
    "onboarding.noAds": "Sin Publicidad Añadida",
    "onboarding.noAdsDesc": "Radio Sphere no añade publicidad. Las estaciones pueden incluir sus propios anuncios en su flujo.",
    "onboarding.tbm": "TimeBack Machine",
    ...
    "tbmQuota.description": "En la web móvil, la TimeBack Machine está limitada a 10 min/día para garantizar la estabilidad. Descarga la aplicación Radio Sphere para escuchar sin límites y en calidad HD.",
    ...
    "home.androidTitle": "Radio Sphere en Android",
    "home.androidDesc": "Escucha tus emisoras favoritas en cualquier lugar, con Android Auto, Chromecast y modo sin conexión.",
  ...
  de: {
    ...
    "tbmModal.intro": "Die TimeBack Machine ist ein exklusives Feature von Radio Sphere, das das Online-Radiohören revolutioniert. Verpasse nie wieder einen wichtigen Live-Moment!",
    "tbmModal.bufferTitle": "🔄 Intelligenter Puffer (5 Minuten)",
    "tbmModal.bufferDesc": "Sobald du einen Sender hörst, zeichnet Radio Sphere automatisch die letzten 5 Minuten in einem Ringpuffer auf. Du musst nichts aktivieren: es ist automatisch und transparent.",
    ...
    "privacy.thirdPartyDesc": "Audio-Streams werden direkt von den Radiosendern über die Radio Browser API bereitgestellt. Die Streams können Werbung enthalten, die direkt von den Sendern eingefügt wird — Radio Sphere kann diese nicht filtern oder blockieren.",
    ...
    "settings.analyticsDesc": "Radio Sphere verwendet Umami Analytics, eine datenschutzfreundliche und DSGVO-konforme Analyselösung.",
    ...
    "onboarding.title": "Willkommen bei Radio Sphere",
    "onboarding.free": "100% Kostenlos",
    "onboarding.freeDesc": "Unbegrenzter Zugang ohne Abo",
    "onboarding.noAds": "Keine Eigenwerbung",
    "onboarding.noAdsDesc": "Radio Sphere fügt keine Werbung hinzu. Sender können eigene Werbung in ihren Streams enthalten.",
    "onboarding.tbm": "TimeBack Machine",
    ...
    "tbmQuota.description": "Im mobilen Web ist die TimeBack Machine auf 10 Min/Tag begrenzt. Laden Sie die Radio Sphere App herunter für unbegrenztes Hören und HD-Qualität.",
  ...
  ja: {
    ...
    "tbmModal.intro": "TimeBack MachineはRadio Sphere独自の機能で、オンラインラジオの聴き方を革新します。大事なライブの瞬間を二度と見逃しません！",
    "tbmModal.bufferTitle": "🔄 スマートバッファ（5分間）",
    "tbmModal.bufferDesc": "局を聴き始めると、Radio Sphereは自動的に直近5分間を循環バッファに記録します。何も有効にする必要はありません：自動で透過的です。",
    ...
    "privacy.dataCollectionDesc": "Radio Sphereは個人を特定できるデータを一切収集しません。サービスの利用に登録は不要です。",
    ...
    "privacy.thirdPartyDesc": "オーディオストリームはRadio Browser APIを通じてラジオ局から直接提供されます。ストリームには放送局が直接挿入した広告が含まれる場合があります — Radio Sphereはそれらをフィルタリングまたはブロックすることができません。",
    ...
    "settings.analyticsDesc": "Radio SphereはUmami Analyticsを使用しています。プライバシーに配慮したGDPR準拠の分析ソリューションです。",
    ...
    "onboarding.noAdsDesc": "Radio Sphereは広告を追加しません。放送局が独自の広告をストリームに含む場合があります。",
    "onboarding.tbm": "TimeBack Machine",
    ...
    "home.androidTitle": "Radio Sphere Android版",
