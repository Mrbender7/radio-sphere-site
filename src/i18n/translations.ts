...
const translations: Record<Language, Record<string, string>> = {
  ...
  ja: {
    ...
    "tbmQuota.description": "Web版のTimeBack Machineには制限があります：巻き戻しは最大2分、録音は最大5分、モバイルでは安定性のため1日合計10分の上限があります。Google Playで無料配布中のプレミアム版なら、最大5分の巻き戻しと最大30分の録音が制限なしで可能です。",
  ...
  nl: {
    ...
    "tbmQuota.description": "Op het web is de TimeBack Machine beperkt: terugspoelen tot 2 minuten en opname tot maximaal 5 minuten, met een totaal quotum van 10 min/dag op mobiel voor stabiliteit. De gratis premium-versie op Google Play laat je tot 5 minuten terugspoelen en tot 30 minuten opnemen, zonder quotum.",
  ...
  pt: {
    ...
    "tbmQuota.description": "Na web, a TimeBack Machine é limitada: rebobinagem até 2 minutos e gravação até 5 minutos no máximo, com uma quota global de 10 min/dia em móvel para garantir a estabilidade. A versão premium gratuita disponível no Google Play permite rebobinar até 5 minutos e gravar até 30 minutos, sem quota.",
  ...
  zh: {
    ...
    "tbmQuota.description": "在网页版中，TimeBack Machine 有所限制：最多回放 2 分钟，录制最长 5 分钟，移动端每天总配额为 10 分钟以确保稳定性。Google Play 上免费提供的高级版可回放最多 5 分钟，录制最长 30 分钟，无配额限制。",
  ...
  tr: {
    ...
    "tbmQuota.description": "Web'de TimeBack Machine sınırlıdır: 2 dakikaya kadar geri sarma ve en fazla 5 dakika kayıt, mobilde kararlılık için günlük toplam 10 dk kotası. Google Play'de bulunan ücretsiz premium sürüm, kotasız olarak 5 dakikaya kadar geri sarma ve 30 dakikaya kadar kayıt imkânı sunar.",
  ...
  ru: {
    ...
    "nav.about": "О нас",
    "sidebar.stationCount": "Более 50 000 радиостанций в 230+ странах, бесплатно, без регистрации.",
    ...
    "welcome.genres": "24 музыкальных жанра",
    "genre.60s": "60-е",
    "genre.70s": "70-е",
    "genre.80s": "80-е",
    "genre.90s": "90-е",
    ...
    "tbmQuota.description": "В веб-версии TimeBack Machine имеет ограничения: перемотка назад до 2 минут и запись до 5 минут максимум, общая квота 10 мин/день на мобильных устройствах для стабильности. Бесплатная премиум-версия в Google Play позволяет перематывать до 5 минут назад и записывать до 30 минут без квоты.",
  ...
  id: {
    ...
    "tbmQuota.description": "Di web, TimeBack Machine terbatas: putar mundur hingga 2 menit dan rekam hingga maks. 5 menit, dengan kuota total 10 mnt/hari di seluler untuk menjaga kestabilan. Versi premium gratis di Google Play memungkinkan putar mundur hingga 5 menit dan rekam hingga 30 menit, tanpa kuota.",
  ...
  ar: {
    ...
    "welcome.genres": "24 نوعاً موسيقياً",
    "genre.60s": "الستينات",
    "genre.70s": "السبعينات",
    ...
    "tbmQuota.description": "على الويب، آلة الزمن محدودة: الإرجاع حتى دقيقتين والتسجيل حتى 5 دقائق كحد أقصى، مع حصة إجمالية تبلغ 10 دقائق/يوم على الجوال لضمان الاستقرار. النسخة المميزة المجانية المتوفرة على Google Play تتيح الإرجاع حتى 5 دقائق والتسجيل حتى 30 دقيقة، دون أي حصة.",
