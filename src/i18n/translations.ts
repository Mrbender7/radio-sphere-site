...
const translations: Record<Language, Record<string, string>> = {
  ...
  tr: {
    ...
    "tbmQuota.description": "Mobil web'de TimeBack Machine kararlılık için günde 10 dk ile sınırlıdır. Sınırsız dinleme için uygulamayı indirin.",
  ...
  ru: {
    ...
    "tbmQuota.description": "В мобильном браузере TimeBack Machine ограничена 10 мин/день. Скачайте приложение для безлимитного прослушивания.",
  ...
  id: {
    ...
    "tbmQuota.description": "Di web seluler, TimeBack Machine dibatasi 10 mnt/hari. Unduh aplikasi untuk mendengarkan tanpa batas.",
  ...
  ar: {
    ...
    "tbmQuota.description": "على الويب الجوال، آلة الزمن محدودة بـ 10 دقائق/يوم لضمان الاستقرار. حمّل تطبيق RadioSphere.be للاستماع غير المحدود وجودة HD.",
