  ...
  return (
    <footer className="border-t border-border bg-secondary/30 backdrop-blur-sm mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mt-8 pt-4 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[10px] text-muted-foreground">
            © {new Date().getFullYear()} Radio Sphere. {t("footer.rights")}
          </p>
          <p className="text-[10px] text-muted-foreground">
            radiosphere.be
          </p>
